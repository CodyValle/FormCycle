...
class ViewController: UIViewController {
    ...
    @IBAction func OrderNext(sender: AnyObject) {
        let NewParams = ["acton":"workOrder","fname": fname.text!, "lname": lname.text!, "address":address.text!, "address2":address2.text!, "city":city.text!, "state":state.text!, "zip":zip.text!, "phone":phone.text!, "email":email.text!]
        do {
